...
Having loaded the data into R, we can proceed to create a first table to summarize some of the variables of interest in the data set. Specifically, we will 
...
```{r top-5-products-table, message = F}
